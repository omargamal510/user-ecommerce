...
function NumState({ title, mainTitle, imgSrc }: NumStateProps) {
  return (
    <>
      <div className="num-stats h-44 col-span-12 md:col-span-6 xl:col-span-3 flex items-center justify-center rounded-lg bg-white dark:bg-darkBg3 shadow-home-element">
